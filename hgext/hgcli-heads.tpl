...
changeset_verbose = '\033[0;31m[{phase}]\033[0m \033[0;33m{node|short}\033[0m:\033[0;33m{node|short}\033[0m{branches} {desc|firstline|strip} \033[1;30m({date|age} by {author|person}){bookmarks}\033[0m{tags}\n'
...
start_activebookmark= '\033[0;32m['
